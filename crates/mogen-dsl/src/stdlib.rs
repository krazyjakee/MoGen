...
const STDLIB_FILES: &[(&str, &str)] = &[
    ...
    // Mesh-import humanoid variants (one per blend source, pre-split into
    // body parts and embedded as `stdlib:humanoid/*.glb` assets in
    // mogen-geom). Each module wraps the 10 part GLBs under one group.
    ("humanoid_female_alternative.mog",       include_str!("../stdlib/humanoid_female_alternative.mog")),
    ("humanoid_female_casual.mog",            include_str!("../stdlib/humanoid_female_casual.mog")),
    ("humanoid_female_dress.mog",             include_str!("../stdlib/humanoid_female_dress.mog")),
    ("humanoid_female_tanktop.mog",           include_str!("../stdlib/humanoid_female_tanktop.mog")),
    ("humanoid_male_casual.mog",              include_str!("../stdlib/humanoid_male_casual.mog")),
    ("humanoid_male_longsleeve.mog",          include_str!("../stdlib/humanoid_male_longsleeve.mog")),
    ("humanoid_male_shirt.mog",               include_str!("../stdlib/humanoid_male_shirt.mog")),
    ("humanoid_male_suit.mog",                include_str!("../stdlib/humanoid_male_suit.mog")),
    ("humanoid_smooth_female_alternative.mog", include_str!("../stdlib/humanoid_smooth_female_alternative.mog")),
    ("humanoid_smooth_female_casual.mog",      include_str!("../stdlib/humanoid_smooth_female_casual.mog")),
    ("humanoid_smooth_female_dress.mog",       include_str!("../stdlib/humanoid_smooth_female_dress.mog")),
    ("humanoid_smooth_female_tanktop.mog",     include_str!("../stdlib/humanoid_smooth_female_tanktop.mog")),
    ("humanoid_smooth_male_casual.mog",        include_str!("../stdlib/humanoid_smooth_male_casual.mog")),
    ("humanoid_smooth_male_longsleeve.mog",    include_str!("../stdlib/humanoid_smooth_male_longsleeve.mog")),
    ("humanoid_smooth_male_shirt.mog",         include_str!("../stdlib/humanoid_smooth_male_shirt.mog")),
    ("humanoid_smooth_male_suit.mog",          include_str!("../stdlib/humanoid_smooth_male_suit.mog")),
