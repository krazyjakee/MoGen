...
use crate::gl_util::{bytes_of_f32, compile_program};
use crate::shaders::{GRID_FS, GRID_VS};
...
impl GridGl {
    pub(crate) fn new(gl: &glow::Context) -> anyhow::Result<Self> {
        unsafe {
    ...
    pub(crate) fn draw(&self, gl: &glow::Context, viewproj: Mat4, camera_pos: Vec3) {
