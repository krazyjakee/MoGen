...
//! - `meta_generate` — fast-model summariser that fills the `meta(name,
//!   description, tags)` block from the active DSL source.
...
pub(super) use spans::{find_clip_source_span, find_material_source_span, find_use_source_span};
